<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ListAllEvent.aspx.cs" Inherits="ListAllEvent" %>
                ...
                <div class="text-card">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <th>
                                <asp:LinkButton CommandName="delete" ID="delete" Text="Delete" runat="server" Font-Bold="false" ForeColor="#009999" Font-Italic="true"></asp:LinkButton>
                            </th>
                        </tr>
                    </table>
                </div>
