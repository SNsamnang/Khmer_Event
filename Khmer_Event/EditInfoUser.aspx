<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="EditInfoUser.aspx.cs" Inherits="EditInfoUser" %>
            ...
            <td width="50%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="font-family:'Times New Roman', Times, serif;font-size:18px"><asp:TextBox CssClass="inputfile" runat="server" Visible="false" ID="txtEventID" Width="100%" Height="25px"></asp:TextBox></td>
                    </tr>
                    <tr>
